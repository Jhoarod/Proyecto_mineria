---
title: "Proyecto_AN"
author: "Jhoan Rodriguez, Jhonatan Peinado"
date: "2025-10-31"
output: pdf_document
editor_options: 
  markdown: 
...
#### Interpretación de la comparación antes y después

Tras la normalización, las variables numéricas quedaron en una escala común (0–1), evitando que diferencias de magnitud afecten el agrupamiento.
Por ejemplo, elevation_m = 30.88 pasó a norm_elevation_m = 0.1157, y drainage_density_km_per_km2 = 11.00 a 0.9000.
Esto permite una comparación equilibrada entre atributos y mejora la coherencia del modelo de clustering.
